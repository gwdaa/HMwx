...
<div>
    ...
    <div class="comment" v-if='showAdd'>
      ...
      <div class="location">
        地理位置：
        <switch color='#272636' :checked='location' @change='getGeo'></switch>
        <span class="text-primary">{{location}}</span>
        <!-- checked 显示switch组件是否选中 -->
      </div>
      <div class="phone">
        手机型号：
        <switch color='#272636' :checked='phone' @change='getPhone'></switch>
...
export default {
  ...
  methods: {
    ...
    getGeo(e) {
      ...
      const ak = 'dTBmAUjV5RoD5QDHKRHyYOADCwo0gzNB';
